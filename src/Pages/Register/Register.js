            ...
            <section className="dark:bg-gray-800 dark:text-gray-100 px-20  lg:px-48">
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <button type="submit" class="text-gray-900 bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-violet-400 dark:hover:bg-violet-700 dark:focus:ring-violet-800">Submit</button>
