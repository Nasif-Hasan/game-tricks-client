...
const Premium = () => {
    ...
    return (
        <section className={`${toggle ? "dark:bg-gray-900" : "dark:bg-gray-200 dark:text-gray-900"} py-10 dark:text-gray-100`}>
            <div className="flex flex-col w-96 p-6 mx-auto space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-800 dark:text-gray-100">
                ...
                <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                    {user?.photoURL ?
                        <img className='rounded-xl h-15'
                            src={user?.photoURL} />
                        : <FaUserCircle className='text-8xl mx-auto'></FaUserCircle>
                    }
