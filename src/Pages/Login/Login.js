                ...
                <div class="p-4 mx-auto max-w-lg sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-900 dark:text-gray-100">
                        ...
                        <div className="my-6 space-y-4">
                            <Link to=''>
                                <button aria-label="Login with Google" type="button" className="flex items-center justify-center mb-3 w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
